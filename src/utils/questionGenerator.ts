...
const generateScience = (grade: number, uName: string, idSuffix: string): Question => {
  ...
  // 中学生向け（分野別・単元対応）
  const scJhsDB = [
    // 🧪 化学分野（化学変化・原子・分子・水溶液・イオン）
    { q: '物質が酸素と化合して別の物質になる化学変化を何というか？', a: '酸化', w: ['還元', '中和', '分解'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '酸化物が酸素を奪われる化学変化を何というか？', a: '還元', w: ['酸化', '中和', '電離'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '水素と酸素が化合して水ができるときの化学反応式で、正しい係数は？ 2H₂ ＋ [   ] → 2H₂O', a: 'O₂', w: ['2O', 'O', '2O₂'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '鉄と硫黄を結びつけるとできる黒い物質は何かな？', a: '硫化鉄', w: ['酸化鉄', '硫酸鉄', '水酸化鉄'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '炭酸水素ナトリウムを加熱分解したときに発生し、石灰水を白く濁らせる気体は？', a: '二酸化炭素', w: ['酸素', '水素', '窒素'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '化学変化の前後で、関係する物質全体の質量の総和が変わらない法則は？', a: '質量保存の法則', w: ['定比例の法則', 'ドルトンの法則', 'エネルギー保存の法則'], tags: ['化学変化', '原子', '分子', '化学'] },
    { q: '酸性とアルカリ性が反応して水と塩ができる反応を何というか？', a: '中和反応', w: ['酸化', '還元', '電解'], tags: ['水溶液', 'イオン', '中和', '酸', 'アルカリ'] },
    { q: '水に溶けて陽イオンと陰イオンに分かれる物質を何というか？', a: '電解質', w: ['非電解質', '混合物', '単体'], tags: ['水溶液', 'イオン', '中和', '酸', 'アルカリ'] },
    { q: '塩化銅水溶液を電気分解したとき、陰極に付着する赤褐色の物質は何？', a: '銅', w: ['塩素', '水素', '酸素'], tags: ['水溶液', 'イオン', '中和', '酸', 'アルカリ'] },
    // 🌍 地学分野（地震・大地・大気・天体）
    { q: '地震で最初に届く、伝わる速度が速い縦波を何というか？', a: 'P波', w: ['S波', '表面波', 'T波'], tags: ['地震', '大地', '火山'] },
    { q: '地震の揺れにおいて、P波の後に届く大きな横波を何というか？', a: 'S波', w: ['P波', 'L波', '海溝波'], tags: ['地震', '大地', '火山'] },
    { q: '大気圧の大きさの標準（1気圧）はおよそ何ヘクトパスカル（hPa）かな？', a: '約1013 hPa', w: ['約100 hPa', '約500 hPa', '約2000 hPa'], tags: ['気圧', '天気', '大気', '前線'] },
    // 🌿 生物分野（細胞・遺伝・植物・人体）
    { q: '細胞分裂のうち、卵や精子などの生殖細胞を作るときに行われる特別な分裂は？', a: '減数分裂', w: ['体細胞分裂', '出芽', '受精'], tags: ['細胞', '遺伝', '生殖', '生物'] },
    { q: '被子植物において、受粉後に成長して種子になる部分はどこかな？', a: '胚珠', w: ['子房', '花粉', 'がく'], tags: ['細胞', '植物', '受精', '生物'] },
    { q: '被子植物において、受粉後に成長して果実になる部分はどこかな？', a: '子房', w: ['胚珠', '花粉', '柱頭'], tags: ['細胞', '植物', '受精', '生物'] },
    { q: 'だ液に含まれ、デンプンを麦芽糖に分解する消化酵素は何かな？', a: 'アミラーゼ', w: ['ペプシン', 'リパーゼ', 'トリプシン'], tags: ['消化', '動物', '体', '生物'] },
    { q: 'メンデルがエンドウ豆の実験で発見した、対になる遺伝子が分かれて配偶子に入る法則は？', a: '分離の法則', w: ['優性の法則', '独立の法則', '保存の法則'], tags: ['細胞', '遺伝', '生殖', '生物'] },
    // ⚡ 物理分野（光・力・仕事）
    { q: '凸レンズの焦点距離の2倍の位置に物体を置いたとき、できる実像の大きさは？', a: '物体と同じ大きさ', w: ['物体より大きい', '物体より小さい', '像はできない'], tags: ['レンズ', '光', '実像', '物理'] },
    { q: '物体に1Nの力を加えて、その力の向きに1m動かしたときの仕事の量は？', a: '1 J（ジュール）', w: ['1 W（ワット）', '1 N', '1 Pa'], tags: ['仕事', '力', 'エネルギー', '物理'] }
  ];

  let candidatePool = scJhsDB;
  if (uName) {
    const matched = scJhsDB.filter(item =>
      item.tags.some(t => uName.includes(t)) || item.q.includes(uName)
    );
    if (matched.length > 0) {
  ...
  const item = candidatePool[getRandomInt(0, candidatePool.length - 1)];
  return {
